...
<main class="w-full px-8">
    ...
    <div class="md:flex md:justify-end grid grid-cols-2 gap-4 gap-x-3">
        <a href="/user/leave/history/{{ Crypt::encrypt('All') }}" class="py-2 block text-center rounded-lg px-7 bg-blue-400 hover:bg-blue-500 text-white font-bold">All</a>
        <a href="/user/leave/history/{{ Crypt::encrypt('Approved') }}" class="py-2 block text-center rounded-lg px-5 bg-green-400 hover:bg-green-500 text-white font-bold">Approved</a>
        <a href="/user/leave/history/{{ Crypt::encrypt('Pending') }}" class="py-2 block text-center rounded-lg px-5 bg-amber-400 hover:bg-amber-500 text-white font-bold">Pending</a>
        <a href="/user/leave/history/{{ Crypt::encrypt('Cancelled') }}" class="py-2 block text-center rounded-lg px-5 bg-red-400 hover:bg-red-500 text-white font-bold">Cancelled</a>
    </div>
