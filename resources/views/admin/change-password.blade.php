...
@section('content')
    <main class="w-full px-8">
        ...
        <div class="mt-4">
            <h1 class="text-xl md:text-2xl font-bold uppercase text-amber-400 mb-4">Change Password</h1>
            <form action="/admin/change/password" method="POST" class="w-80 mt-4">
                @csrf
                <div>
                ...
                <button class="block w-32 py-3 bg-amber-400 text-white text-center font-medium rounded-md mt-4">Sumbit</button>
            </form>
        </div>
    </main>
@endsection
